...
function Instant() {
  ...
  const stationsByDivision = {
    ZONE1: ["Nagla_Imarti", "Shiv_Temple", "Primary_School"],
    ZONE2: ["Aanganwadi", "Gauri_Talab", "Near_Maharana_Partab"],
    ZONE3: ["Sanik_Vihar", "Raj_Vihar"],
  };
  ...
  const ZONE1_S1 = useAPi(Base_Url + "opzone1/101");
  const ZONE1_S2 = useAPi(Base_Url + "opzone1/102");
  const ZONE1_S3 = useAPi(Base_Url + "opzone1/103");
  const ZONE2_S1 = useAPi(Base_Url + "opzone2/101");
  const ZONE2_S2 = useAPi(Base_Url + "opzone2/102");
  const ZONE2_S3 = useAPi(Base_Url + "opzone2/103");
  const ZONE3_S1 = useAPi(Base_Url + "opzone3/101");
  const ZONE3_S2 = useAPi(Base_Url + "opzone3/102");
  ...
  const CheckChange = () => {
    switch (true) {
      case division === "ZONE1" && station === "Nagali_Imarti":
        console.log("Nagali_Imarti");
        ZONE1_S1.getReq();
      ...
      //KAHRAKMAFF
      case division === "ZONE1" && station === "Shiv_Temple":
        ZONE1_S2.getReq();
      ...
      case division === "ZONE1" && station === "Primary_School":
        ZONE1_S3.getReq();
        DisplayData1(ZONE1_S3.APIdata);
        Set_Pump(3);
        break;

      case division === "ZONE2" && station === "Aaganwadi":
        ZONE2_S1.getReq();
        DisplayData1(ZONE2_S1.APIdata);
        Set_Pump(4);
        break;
      case division === "ZONE2" && station === "Gauri_Talab":
        ZONE2_S2.getReq();
        DisplayData1(ZONE2_S2.APIdata);
        Set_Pump(5);
        break;

      case division === "ZONE2" && station === "Near_Maharana_Partab":
        ZONE2_S3.getReq();
        DisplayData1(ZONE2_S3.APIdata);
        Set_Pump(6);
        break;

      case division === "ZONE3" && station === "Sanik_Vihar":
        ZONE3_S1.getReq();
        DisplayData1(ZONE3_S1.APIdata);
        Set_Pump(7);
        break;

      case division === "ZONE3" && station === "Raj_Vihar":
        ZONE3_S2.getReq();
